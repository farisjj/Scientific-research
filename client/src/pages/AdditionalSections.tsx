  ...
  return (
    <section id="case-reports" className="mb-16 scroll-mt-20">
      ...
      <AccordionSection title="الخطوات العملية: من سرير المريض حتى النشر">
        <div className="space-y-6">
          <div>
            <h4 className="font-semibold text-[#0F3A7D] dark:text-blue-400 mb-3">الخطوة 1: صيد الحالة (The Hunt)</h4>
          ...
          <div>
            <h4 className="font-semibold text-[#0F3A7D] dark:text-blue-400 mb-3">الخطوة 2: الـ Informed Consent</h4>
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
          ...
          <div>
            <h4 className="font-semibold text-[#0F3A7D] dark:text-blue-400 mb-3">الخطوة 3: جمع البيانات (Data Collection)</h4>
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
          ...
          <div>
            <h4 className="font-semibold text-[#0F3A7D] dark:text-blue-400 mb-3">الخطوة 4: الـ Literature Review</h4>
            <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
          ...
          <div>
            <h4 className="font-semibold text-[#0F3A7D] dark:text-blue-400 mb-3">الخطوة 5: الكتابة (CARE Guidelines)</h4>
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <div>
                <strong className="text-[#0F3A7D] dark:text-blue-400">الـ Introduction:</strong>
                <p>فقرة سريعة تشرح المرض ولماذا هذه الحالة استثنائية.</p>
              </div>
              <div>
                <strong className="text-[#0F3A7D] dark:text-blue-400">الـ Case Presentation:</strong>
              ...
              <div>
                <strong className="text-[#0F3A7D] dark:text-blue-400">الـ Discussion:</strong>
                <p>قارن مريضك بالحالات القليلة المنشورة؛ ماذا اختلف عنهم؟ وما هو التفسير العلمي لما حدث معه؟</p>
              </div>
              <div>
                <strong className="text-[#0F3A7D] dark:text-blue-400">الـ Conclusion:</strong>
  ...
  return (
    <section id="systematic-reviews" className="mb-16 scroll-mt-20">
      ...
      <AccordionSection title="خطوات العمل (The PRISMA Protocol)">
        <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
          <p>1. تحديد السؤال (PICO): من هم المرضى (P)؟ ما هو التدخل (I)؟ بماذا ستقارن (C)؟ وما هي النتيجة (O)؟</p>
      ...
      >
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            <div className="mt-1"><KeywordBadge>Impact Factor</KeywordBadge></div>
          ...
          <div className="flex items-start gap-3">
            <div className="mt-1"><KeywordBadge>Indexing</KeywordBadge></div>
          ...
          <div className="flex items-start gap-3">
            <div className="mt-1"><KeywordBadge>Open Access</KeywordBadge></div>
